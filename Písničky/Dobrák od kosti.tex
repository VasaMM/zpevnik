...
\slokaBezCisla{
\DSiroky\ASiroky\GSiroky\GSiroky\akord{$2\times$}
\vspace{-1em}
}
...
\refren{
\D Je to vážně silná \X káva, \A pláč a nebo \X vztek \G nic už s tím \X nenaděláš,\XSiroky\XSiroky\\
\D nech mě jenom \X hádat, \A jak jsi hebká na \X dotek \G krásná a \X nedospělá.\XSiroky\XSiroky
}
...
\sloka{
\D Sejde z očí \X sejde z mysli, \A jenom blázen věří \X na nesmysly,\\
\G láska je čaroděj \X a ticho prý léčí, \X ale zákon hovoří \X jasnou řečí.
}
